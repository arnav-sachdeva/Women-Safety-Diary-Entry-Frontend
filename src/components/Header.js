...
export default function(props){
    ...
    */
        ...
        <div className="Header">
            <div className='Dropdown'>
                ...
                <div className='DropdownContent'>
                    ...
                    <a href="http://sea-turtle-app-52yvl.ondigitalocean.app/auth/logout">Logout</a>
                </div>
            </div>
    ...
    (
        <div className="Header">
            <div className='SignIn-Button' onClick={()=>window.location.href='http://sea-turtle-app-52yvl.ondigitalocean.app/auth/google'}>Sign In</div>
            <div className='Header-Flex'>
                <img src={process.env.PUBLIC_URL + '/favicon.ico'} alt='Notes-Logo'/>
                <div className='Heading'>SafeHer</div>
            </div>
